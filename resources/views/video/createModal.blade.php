    ...
    <div class="row">
        <div class="col-xs-12 col-sm-8">
            ...
            <div class="form-group">
                ...
                <textarea style="height:107px" placeholder="Post Description" class="form-control" name="description" id="description"></textarea>
        ...
        <div class="col-xs-12 col-sm-4">
            <div class="form-group">
                <label class="control-label">Thumbnail text</label>
                <input type="text" name="thumbnail_text" class="form-control thumbnail_text" id="thumbnail_text" placeholder="Put thumb nail text here">
                <p class="error-msg error-thumbnail_text"></p>
            </div>
            <div class="form-group">
